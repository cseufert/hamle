...
class Parser
{
  ...
  {
    return new \Seufert\Hamle\TextNode\StringLit(join('', $text));
  }
  private function peg_f3($body)
  {
    return $body;
  }
  private function peg_f4($name)
  {
    return new \Seufert\Hamle\TextNode\ScopeId(
      null,
      null,
      new \Seufert\Hamle\TextNode\ModelParam($name),
    );
  }
  private function peg_f5($expr, $chain)
  {
    if (!$chain) {
      return $expr;
    }
    $top = array_pop($chain);
    while ($chain) {
      $top = array_pop($chain)->withChain($top);
    }
    return $expr->withChain($top);
  }
  private function peg_f6($sub)
  {
    return $sub;
  }
  private function peg_f7($filter)
  {
    return $filter;
  }
  private function peg_f8($name)
  {
    return new \Seufert\Hamle\TextNode\ModelParam($name, null);
  }
  private function peg_f9($query)
  {
    return $query;
  }
  private function peg_f10($id)
  {
    return new \Seufert\Hamle\TextNode\ScopeId($id);
  }
  private function peg_f11($name)
  {
    return new \Seufert\Hamle\TextNode\ScopeName($name);
  }
  private function peg_f12($query, $chain)
  {
    return (new \Seufert\Hamle\TextNode\Query($query))->withImmStack($chain);
  }
  private function peg_f13($scope, $chain)
  {
    return $scope->withImmStack($chain);
  }
  private function peg_f14($chain)
  {
    return (new \Seufert\Hamle\TextNode\ScopeId(null))->withImmStack($chain);
  }
  private function peg_f15($query)
  {
    return new \Seufert\Hamle\TextNode\Query($query);
  }
  private function peg_f16($id, $query)
  {
    return array_merge([['q' => 'type', 'id' => $id]], $query);
  }
  private function peg_f17($query)
  {
    return array_merge([['q' => 'type', 'id' => '*']], $query);
  }
  ...
  private function peg_f20($id)
  {
    return ['q' => 'type', 'id' => $id];
  }
  private function peg_f21($id)
  {
    return ['q' => 'tag', 'id' => $id];
  }
  private function peg_f22($id)
  {
    return ['q' => 'sort', 'id' => $id];
  }
  private function peg_f23($id)
  {
    return ['q' => 'group', 'id' => $id];
  }
  private function peg_f24($offset, $limit)
  {
    return ['q' => 'range', 'limit' => $limit, 'offset' => $offset];
  }
  private function peg_f25($limit)
  {
    return ['q' => 'range', 'limit' => $limit, 'offset' => 0];
  }
  private function peg_f26($name, $param)
  {
    return new \Seufert\Hamle\TextNode\ModelParam($name, $param);
  }
  private function peg_f27($f, $chain)
  {
    return $f->withChain($chain);
  }
  private function peg_f28($f)
  {
    return $f;
  }
  private function peg_f29($func, $args)
  {
    return new \Seufert\Hamle\TextNode\FilterFunc($func, null, $args);
  }
  private function peg_f30($func)
  {
    return new \Seufert\Hamle\TextNode\FilterFunc($func);
  }
  private function peg_f31($arg)
  {
    return $arg;
  }
  private function peg_f32($s, $n, $d)
  {
    return \Seufert\Hamle\TextNode\FloatLit((float) "$s$n.$d");
  }
  private function peg_f33($parts)
  {
    return new \Seufert\Hamle\TextNode\StringLit($parts[1]);
  }
  private function peg_f34($chars)
  {
    return join('', $chars);
  }
  private function peg_f35($char_)
  {
    return $char_;
  }
  private function peg_f36($sequence)
  {
    return $sequence;
  }
  private function peg_f37($char)
  {
    return $char;
  }
  private function peg_f38($n)
  {
    return (int) join('', $n);
  }
  ...
  private function peg_f43($c)
  {
    return $c;
  }
  private function peg_f44($char_)
  {
    return str_replace(['n', 'r', 't'], ['\\n', '\\r', '\\t'], $char_);
  }
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          ...
          if ($s2 !== $this->peg_FAILED) {
            ...
            if ($s3 !== $this->peg_FAILED) {
              if (
                $this->input_substr($this->peg_currPos, 1) === $this->peg_c10
              ) {
                $s4 = $this->peg_c10;
                $this->peg_currPos++;
              } else {
  ...
  private function peg_parseQueryRelation()
  {
    ...
    if ($s1 !== $this->peg_FAILED) {
      if (
        peg_regex_test(
          $this->peg_c20,
          $this->input_substr($this->peg_currPos, 1),
        )
      ) {
        ...
        if ($s0 === $this->peg_FAILED) {
          ...
          if ($s0 === $this->peg_FAILED) {
            ...
            if ($s1 !== $this->peg_FAILED) {
              ...
              if ($s2 !== $this->peg_FAILED) {
                if (
                  $this->input_substr($this->peg_currPos, 1) === $this->peg_c34
                ) {
                  $s3 = $this->peg_c34;
                  $this->peg_currPos++;
                } else {
            ...
            if ($s0 === $this->peg_FAILED) {
              $s0 = $this->peg_currPos;
              if (
                $this->input_substr($this->peg_currPos, 1) === $this->peg_c32
              ) {
                $s1 = $this->peg_c32;
                $this->peg_currPos++;
              } else {
  ...
  private function peg_parseInteger()
  {
    ...
    $s1 = [];
    if (
      peg_regex_test($this->peg_c40, $this->input_substr($this->peg_currPos, 1))
    ) {
      $s2 = $this->input_substr($this->peg_currPos, 1);
      $this->peg_currPos++;
    } else {
  ...
  private function peg_parseIdentifier()
  {
    ...
    $s1 = [];
    if (
      peg_regex_test($this->peg_c50, $this->input_substr($this->peg_currPos, 1))
    ) {
      $s2 = $this->input_substr($this->peg_currPos, 1);
      $this->peg_currPos++;
    } else {
  ...
  private function peg_parseIdentifierDash()
  {
    $s0 = $this->peg_currPos;
    if (
      peg_regex_test($this->peg_c52, $this->input_substr($this->peg_currPos, 1))
    ) {
  ...
  private function peg_parseAlphaNum()
  {
    ...
    $s1 = [];
    if (
      peg_regex_test($this->peg_c54, $this->input_substr($this->peg_currPos, 1))
    ) {
      $s2 = $this->input_substr($this->peg_currPos, 1);
      $this->peg_currPos++;
    } else {
  ...
  {
    if (
      peg_regex_test($this->peg_c62, $this->input_substr($this->peg_currPos, 1))
    ) {
      $s0 = $this->input_substr($this->peg_currPos, 1);
      $this->peg_currPos++;
    } else {
  ...
  private function peg_parseSingleEscapeCharacter()
  {
    $s0 = $this->peg_currPos;
    if (
      peg_regex_test($this->peg_c64, $this->input_substr($this->peg_currPos, 1))
    ) {
      $s1 = $this->input_substr($this->peg_currPos, 1);
      $this->peg_currPos++;
    } else {
  ...
  public function parse($input)
  {
    ...
    $this->peg_c42 = ['type' => 'other', 'description' => 'string'];
    $this->peg_c43 = "\"";
    $this->peg_c44 = [
      'type' => 'literal',
      'value' => "\"",
    ...
    $this->peg_c49 = ['type' => 'any', 'description' => 'any character'];
    ...
    $peg_startRuleFunctions = [
      'HtmlInput' => [$this, 'peg_parseHtmlInput'],
      'CodeInput' => [$this, 'peg_parseCodeInput'],
      'ControlInput' => [$this, 'peg_parseControlInput'],
    ];
    $peg_startRuleFunction = [$this, 'peg_parseHtmlInput'];
    ...
    if (
      $peg_result !== $this->peg_FAILED &&
      $this->peg_currPos === $this->input_length
    ) {
      ...
      $exception = $this->peg_buildException(
        null,
        $this->peg_maxFailExpected,
        $this->peg_maxFailPos,
      );
